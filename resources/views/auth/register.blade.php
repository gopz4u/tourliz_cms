...
<body>
    <div class="register-container">
        ...
        <div class="auth-card">
            ...
            @if ($errors->has('name') || ($errors->has('email') && old('name')) || $errors->has('password') && old('name'))
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="form-group">
                    <label for="register_name"><i class="bi bi-person"></i> Full Name</label>
                    <input type="text" 
                ...
                <div class="form-group">
                    <label for="register_email"><i class="bi bi-envelope"></i> Email Address</label>
                    <input type="email" 
                ...
                <div class="form-group">
                    <label for="register_password"><i class="bi bi-lock"></i> Password</label>
                    <input type="password" 
