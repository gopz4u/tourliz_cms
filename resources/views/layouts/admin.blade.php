...
<head>
    ...
    <style>
        :root {
            --primary: #5a52e5;        /* Purple-indigo from image */
            --primary-hover: #4e46c7;
            --primary-light: #efeffd;
            --sidebar-width: 280px;
            --bg-body: #f4f6fa;       /* Very light gray/blue background */
            --bg-surface: #ffffff;    /* White card background */
            --text-main: #0f172a;
            --text-muted: #94a3b8;
            --text-muted-darker: #64748b;
            --app-radius: 2.5rem;     /* Large tablet-like radius */
        ...
        .nav-badge {
            margin-left: auto;
            background: #ff5e3a; /* Orange badge from picture */
            color: white;
            font-size: 0.7rem;
            width: 22px;
            height: 22px;
        ...
        @media (max-width: 991.98px) {
            body {
                padding: 0; /* Remove body padding so it's edge-to-edge */
            }
            .app-wrapper {
                flex-direction: column;
                min-height: 100vh;
                border-radius: 0; /* No outside border radius on mobile */
            }
            .sidebar {
                position: fixed;
                top: 0;
            ...
            .main-content {
                padding: 0.75rem; /* Very tight padding for mobile */
            }
            .mobile-header {
                display: flex;
                align-items: center;
                justify-content: space-between;
                border-radius: 0; /* Edge to edge header */
                margin-bottom: 0; 
                padding: 10px 15px;
            }
            ...
            .card {
                border-radius: 12px; /* Smaller radii for phone screen */
                margin-bottom: 1rem;
            }
...
<body>
    ...
    <div class="mobile-header d-lg-none">
        <div class="d-flex align-items-center">
            ...
            <span class="fs-5 fw-bold" style="color: var(--text-main); letter-spacing:-0.5px;">Tourliz</span>
        </div>
        ...
        <div class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                @if(auth()->user()->isSuperAdmin())
                    ...
                    <li>
                        <a href="{{ route('admin.group-packages.index') }}" class="{{ request()->routeIs('admin.group-packages.*') ? 'active' : '' }}">
                    ...
                    <li>
                        <a href="{{ route('admin.package-offers.index') }}" class="{{ request()->routeIs('admin.package-offers.*') ? 'active' : '' }}">
                ...
                <li class="nav-item">
                    <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#collapseB2B" aria-expanded="false" aria-controls="collapseB2B">
                    ...
                    <div id="collapseB2B" class="collapse {{ request()->routeIs('admin.agencies.*') || request()->routeIs('admin.b2b-itineraries.*') ? 'show' : '' }}">
                        <div class="collapse-inner">
                            <a class="dropdown-item {{ request()->routeIs('admin.agencies.*') ? 'fw-bold' : '' }}" href="{{ route('admin.agencies.index') }}">
                                Manage Agencies
                            </a>
                            <a class="dropdown-item {{ request()->routeIs('admin.b2b-itineraries.*') ? 'fw-bold' : '' }}" href="{{ route('admin.b2b-itineraries.index') }}">
                                Custom Proposals
                            </a>
                        </div>
                    </div>
                ...
                <li class="nav-item">
                    <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#collapseB2C" aria-expanded="false" aria-controls="collapseB2C">
                        <i class="bi bi-person-badge-fill main-icon"></i>
                        <span>B2C Sales</span>
                        <i class="bi bi-chevron-down ms-auto" style="font-size: 0.8rem; opacity: 0.5;"></i>
                    </a>
                    <div id="collapseB2C" class="collapse {{ request()->routeIs('admin.b2c-itineraries.*') ? 'show' : '' }}">
                        <div class="collapse-inner">
                            <a class="dropdown-item {{ request()->routeIs('admin.b2c-itineraries.create') ? 'fw-bold' : '' }}" href="{{ route('admin.b2c-itineraries.create') }}">
                                New Walk-in Lead
                            </a>
                            <a class="dropdown-item {{ request()->routeIs('admin.b2c-itineraries.index') && !request()->routeIs('admin.b2c-itineraries.create') ? 'fw-bold' : '' }}" href="{{ route('admin.b2c-itineraries.index') }}">
                                Manage Leads
                            </a>
                        </div>
                    </div>
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseGroups" class="collapse {{ request()->routeIs('admin.group-itineraries.*') ? 'show' : '' }}">
                        <div class="collapse-inner">
                            <a class="dropdown-item {{ request()->routeIs('admin.group-itineraries.create') ? 'fw-bold' : '' }}" href="{{ route('admin.group-itineraries.create') }}">
                                New Group Lead
                            </a>
                            <a class="dropdown-item {{ request()->routeIs('admin.group-itineraries.index') && !request()->routeIs('admin.group-itineraries.create') ? 'fw-bold' : '' }}" href="{{ route('admin.group-itineraries.index') }}">
                                Manage Groups
                            </a>
                        </div>
                    </div>
                    ...
                    <li class="nav-item">
                        ...
                        <div id="collapseInventory" class="collapse {{ request()->routeIs('admin.hotels.*') || request()->routeIs('admin.activities.*') || request()->routeIs('admin.transports.*') || request()->routeIs('admin.entry-tickets.*') || request()->routeIs('admin.meals.*') || request()->routeIs('admin.tourist-spots.*') || request()->routeIs('admin.suppliers.*') ? 'show' : '' }}">
                            <div class="collapse-inner">
                                ...
                                <div class="ps-2 mt-1">
                                    <div style="font-size:0.68rem; text-transform:uppercase; letter-spacing:1px; font-weight:700; color:#94a3b8; padding:2px 12px;">By Category</div>
                                    <a class="dropdown-item py-1 {{ request('type') == 'Hotel' ? 'fw-bold' : '' }}" href="{{ route('admin.suppliers.index') }}?type=Hotel">
                                        <i class="bi bi-building me-1 text-primary" style="font-size:0.8rem;"></i> Hotel
                                    </a>
                                    <a class="dropdown-item py-1 {{ request('type') == 'Transport' ? 'fw-bold' : '' }}" href="{{ route('admin.suppliers.index') }}?type=Transport">
                                    ...
                                    <a class="dropdown-item py-1 {{ request('type') == 'Other' ? 'fw-bold' : '' }}" href="{{ route('admin.suppliers.index') }}?type=Other">
