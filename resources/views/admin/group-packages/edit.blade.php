...
@section('title', 'Edit Group Package')
...
<style>
    ...
    .step-item.active .step-title { color: #0052cc; }
    ...
    .wizard-body { padding: 4rem; }

    .form-step { display: none; }
    .form-step.active { display: block; animation: slideIn 0.5s ease-out forwards; }
    ...
    /* UI Components */
    .premium-label { font-weight: 700; color: #1e293b; margin-bottom: 0.75rem; font-size: 0.9rem; }
    .premium-input {
        background: #f8fafc;
    ...
    .itinerary-day-card:hover { border-color: #0052cc; box-shadow: 0 15px 40px rgba(0,0,0,0.05); }
    ...
    .dropzone-box:hover { border-color: #0052cc; background: #eff6ff; }
...
<div class="wizard-container py-5">
    ...
    <div class="d-flex justify-content-between align-items-end mb-5">
        <div>
            <h1 class="fw-black text-dark tracking-tight mb-1" id="page-title-main"><i class="bi bi-pencil-square"></i> Edit Group Package</h1>
            <p class="text-muted mb-0">Updating collaborative group tour configurations</p>
        </div>
        <div class="text-end">
    ...
    <div class="wizard-stepper mb-5">
        <div class="step-item active" data-step="1">
            ...
            <div class="step-title">Fundamentals</div>
        </div>
    ...
    <form id="group-package-wizard-form" enctype="multipart/form-data">
        <div class="wizard-card">
            <div class="wizard-body p-4 p-md-5">
                ...
                <div class="form-step active" id="step-1">
                    <div class="mb-5">
                        ...
                        <input type="text" name="name" id="name" class="form-control premium-input form-control-lg fs-4 fw-bold" placeholder="Ex: Grand Europe Scenic Group Tour" required>
                    ...
                    <div class="row g-5">
                        <div class="col-md-8">
                            <div class="row g-4">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select name="location" id="location_select" class="form-select select2" disabled required>
                                        <option value="">Select Location</option>
                                    </select>
                                </div>
                                <div class="col-md-4">
                                    <label class="premium-label">Primary City <span class="text-danger">*</span></label>
                                    <select name="destination_id" id="destination_id" class="form-select select2" disabled required>
                                        <option value="">Select City</option>
                                    </select>
                                </div>

                                <div class="col-md-6">
                                    <label class="premium-label">Service Categories <span class="text-danger">*</span></label>
                                    <select name="categories[]" id="categories" class="form-select select2" multiple required data-placeholder="Select Categories">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="package_category" id="package_category" class="form-select premium-input">
                                ...
                                <div class="col-md-12">
                                    <label class="premium-label">Source Vendors (Suppliers) <span class="text-danger">*</span></label>
                                    <select name="supplier_ids[]" id="supplier_ids" class="form-select select2" multiple required data-placeholder="Search Vendors">
                                    </select>
                                    <small class="text-muted">Select all vendors providing services for this package.</small>
                                </div>
                            </div>
                            ...
                            <div class="row g-4 mt-1 border-top pt-4">
                                ...
                                <div id="hotel-amenities" class="col-12 amenities-section" style="display: none;">
                                    <h6 class="fw-bold mb-3 text-primary"><i class="bi bi-building"></i> Hotel Details</h6>
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            <label class="premium-label">Star Rating</label>
                                            <select class="form-select premium-input" id="star_rating" name="star_rating">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control premium-input" id="accommodation_type" name="accommodation_type" placeholder="Resort, Villa, Boutique Hotel">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div id="transport-amenities" class="col-12 amenities-section" style="display: none;">
                                    <h6 class="fw-bold mb-3 text-warning"><i class="bi bi-car-front"></i> Transportation Details</h6>
                                    <div>
                                        <label class="premium-label">Vehicle Type</label>
                                        <input type="text" class="form-control premium-input" id="vehicle_type" name="vehicle_type" placeholder="Sedan, SUV, Coaster Bus, Van">
                                    </div>
                                </div>

                                <!-- Tickets Specific Amenities -->
                                <div id="ticket-amenities" class="col-12 amenities-section" style="display: none;">
                                    <h6 class="fw-bold mb-3 text-success"><i class="bi bi-ticket-perforated"></i> Entry Tickets Details</h6>
                                    <div class="row g-3">
                                        <div class="col-md-8">
                                            <label class="premium-label">Ticket Name</label>
                                            <input type="text" class="form-control premium-input" id="ticket_name" name="ticket_name" placeholder="VIP Pass, Full Admission, Combo Entry">
                                        </div>
                                        <div class="col-md-4">
                                            <label class="premium-label">Ticket Count</label>
                                            <input type="number" class="form-control premium-input" id="ticket_count" name="ticket_count" min="1" placeholder="Qty">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row g-4 mt-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="slug" id="slug" class="form-control premium-input" placeholder="Slug identifier">
                                </div>
                                <div class="col-md-6">
                                    <label class="premium-label">Flight Ticket Included?</label>
                                    <div class="d-flex gap-3 mt-2">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="includes_flight" id="includes_flight_yes" value="1">
                                            <label class="form-check-label small fw-bold" for="includes_flight_yes">Yes</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="includes_flight" id="includes_flight_no" value="0">
                                            <label class="form-check-label small fw-bold" for="includes_flight_no">No</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-5">
                                ...
                                <input type="file" id="hero-img" class="d-none" accept="image/*" onchange="uploadCoverImage(this)">
                                <input type="hidden" id="image_path" name="image">
                                <div id="hero-preview" class="mt-3 d-none position-relative">
                                    <img src="" class="img-fluid rounded-4 shadow-sm border" style="max-height: 200px; width: 100%; object-fit: cover;">
                                    <button type="button" class="btn btn-sm btn-danger rounded-circle position-absolute top-0 end-0 m-2" onclick="clearHeroPreview()">
                            ...
                            <div class="mb-5">
                                ...
                                <input type="file" id="gallery-img" class="d-none" multiple accept="image/*" onchange="$('#upload-gallery-btn').toggle($(this)[0].files.length > 0)">
                                <button type="button" class="btn btn-sm btn-dark w-100 mt-2" id="upload-gallery-btn" style="display:none;" onclick="uploadGallery(this)">
                            ...
                            <div class="bg-light p-4 rounded-4 border">
                                ...
                                <div class="form-check form-switch mb-3">
                                    ...
                                    <label class="form-check-label small fw-bold" for="is_featured">Mark as Featured</label>
                                </div>
                ...
                <div class="form-step" id="step-2">
                    <div class="bg-white border rounded-4 p-4 p-md-5 mb-5 shadow-sm">
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            <div>
                                <h4 class="fw-black text-dark mb-1"><i class="bi bi-cpu text-primary"></i> Package Cost Components</h4>
                                <p class="text-muted small mb-0">Add suppliers, rooms, transport, or tickets to dynamically build the base cost.</p>
                            </div>
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-5">
                        <div>
                            <h4 class="fw-black text-dark mb-1"><i class="bi bi-calendar-range text-primary"></i> Day-by-Day Itinerary</h4>
                            <p class="text-muted small mb-0">Total Duration: <span id="dur-count" class="fw-bold text-primary">0 Days</span></p>
                        </div>
                        <button type="button" class="btn btn-outline-primary rounded-pill px-4" onclick="addItineraryDay()">
                    ...
                    <div class="row g-5">
                        <div class="col-md-7">
                            ...
                            <div class="row g-4 mt-2">
                                <div class="col-md-6">
                                    <label class="premium-label">Net Price (Vendor Cost) <span class="text-danger">*</span></label>
                                    <input type="number" step="0.01" name="net_price" id="net_price" class="form-control premium-input text-success fw-bold" readonly required>
                                </div>
                                <div class="col-md-6">
                                    <label class="premium-label">Service Markup (%)</label>
                                    <input type="number" step="0.01" name="markup_percentage" id="markup_percentage" class="form-control premium-input" value="10">
                                </div>
                                <div class="col-md-6">
                                    <label class="premium-label">Selling Price (Adult) <span class="text-danger">*</span></label>
                                    <input type="number" step="0.01" name="price" id="price" class="form-control premium-input form-control-lg fw-black text-primary" required>
                                    <small class="text-muted">Formula: Vendor Cost + Markup Amount</small>
                                </div>
                                <div class="col-md-6">
                                    <label class="premium-label">Discount Price</label>
                                    <input type="number" step="0.01" name="discount_price" id="discount_price" class="form-control premium-input">
                                </div>
                                <div class="col-md-6">
                                    <label class="premium-label">Kids Price (Age 2-6)</label>
                                    <input type="number" step="0.01" name="price_2_6" id="price_2_6" class="form-control premium-input">
                                </div>
                                <div class="col-md-6">
                                    <label class="premium-label">Kids Price (Age 6-10)</label>
                                    <input type="number" step="0.01" name="price_6_10" id="price_6_10" class="form-control premium-input">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-5">
                            <div class="bg-light border rounded-4 p-4 mb-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control premium-input" id="announcement_date" name="announcement_date">
                                </div>
                                <div class="mb-3">
                                    <label class="premium-label">Total Pax (Passenger Limit)</label>
                                    <input type="number" class="form-control premium-input" id="total_pax" name="total_pax" min="1" placeholder="Total passenger limit">
                                </div>
                            </div>
                ...
                <div class="form-step" id="step-4">
                    <div class="mb-4">
                        ...
                        <div id="description-editor" style="height: 250px; border-radius: 16px; background: #f8fafc; border: 1px solid #f1f5f9;"></div>
                    ...
                    <div class="row g-4 mt-3">
                        <div class="col-md-6">
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                ...
                                <button type="button" class="btn btn-sm btn-outline-success" onclick="addInclusionRow()">
                    ...
                    <div class="row g-4 mt-4">
                        <div class="col-md-12">
                            ...
                            <textarea name="short_description" id="short_description" class="form-control premium-input" rows="3" placeholder="Brief highlights of this package..."></textarea>
                        </div>
                    </div>
                    ...
                    <div class="row g-4 mt-5">
                        <div class="col-12">
                            <div class="bg-light p-4 rounded-4 border">
                                <h6 class="fw-bold mb-4 text-primary"><i class="bi bi-search me-2"></i> Search Engine Optimization (SEO)</h6>
                                <div class="row g-4">
                                    <div class="col-md-6">
                                        <label class="premium-label small">Meta Title</label>
                                        <input type="text" name="meta_title" id="meta_title" class="form-control premium-input" placeholder="SEO optimized title">
                                    </div>
                                    <div class="col-md-6">
                                        <label class="premium-label small">Meta Keywords</label>
                                        <input type="text" name="meta_keywords" id="meta_keywords" class="form-control premium-input" placeholder="travel, maldives, luxury, tour">
                                    </div>
                                    <div class="col-12">
                                        <label class="premium-label small">Meta Description</label>
                                        <textarea name="meta_description" id="meta_description" class="form-control premium-input" rows="3" placeholder="Brief summary for Google search results..."></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="wizard-footer">
                <button type="button" class="btn btn-link text-muted fw-bold text-decoration-none" id="btn-prev" style="display:none;" onclick="step(-1)">
                ...
                <div class="ms-auto d-flex align-items-center gap-4">
                    ...
                    <button type="button" class="btn btn-success rounded-pill px-5 py-3 fw-bold" id="btn-save-immediate" onclick="submitPackageForm()">
                        Update Package <i class="bi bi-check-circle ms-2"></i>
                    </button>
                    ...
                    <button type="button" class="btn btn-publish px-5 py-3" id="btn-publish" style="display:none;" onclick="submitPackageForm()">
                        FINISH & UPDATE <i class="bi bi-rocket-takeoff ms-2"></i>
                    </button>
                </div>
            </div>
        </div>
    ...
    <div class="itinerary-day-card itinerary-day" id="day-{N}" data-day="{N}">
        <div class="day-header">
            <div class="d-flex align-items-center gap-3">
                ...
                <input type="text" class="form-control border-0 bg-transparent fw-black fs-5 day-title" placeholder="Day Theme (e.g. Arrival & Sunset Cruise)" style="width: 400px; outline:none;" required>
            </div>
            <button type="button" class="btn btn-outline-danger btn-sm border-0 rounded-circle" onclick="removeItineraryDay('day-{N}')">
                <i class="bi bi-x-lg"></i>
            </button>
        </div>
        <div class="p-4">
            <div class="row g-4">
                <div class="col-md-6">
                    <label class="premium-label"><i class="bi bi-geo-alt-fill text-danger me-2"></i> Destinations</label>
                    <select class="form-select select2-spots-multi day-destinations" multiple="multiple" style="width: 100%;">
                    </select>
                </div>
                <div class="col-md-6">
                    <label class="premium-label"><i class="bi bi-egg-fried text-warning me-2"></i> Meals Included</label>
            ...
            <div class="mt-4">
                ...
                <textarea class="form-control premium-input day-description" rows="3" placeholder="Describe the day's journey..."></textarea>
            </div>

            <div class="bg-light p-4 rounded-4 border mt-4">
                <p class="small fw-bold mb-3 text-primary"><i class="bi bi-link-45deg"></i> LINKED SERVICES (FROM COST COMPONENTS)</p>
                
                <!-- HOTEL ROW -->
                <div class="row g-3 align-items-center mb-3">
                    <div class="col-md-2">
                        <span class="badge bg-primary-subtle text-primary py-2 px-3 rounded-pill w-100"><i class="bi bi-building"></i> Hotel</span>
                    </div>
                    <div class="col-md-8">
                    ...
                    <div class="col-md-2 text-end">
                        <button type="button" class="btn btn-sm btn-outline-primary w-100" onclick="toggleCustomHotel(this)" style="border-radius:12px;">
                            <i class="bi bi-plus"></i> Custom
                        </button>
                    </div>
                    <div class="col-12 custom-hotel-row" style="display:none;">
                        <input type="text" class="form-control premium-input mt-1 day-custom-hotel" placeholder="Enter custom hotel name (e.g. Hilton Resort, Langkawi)">
                    </div>
                </div>
                ...
                <div class="row g-3 align-items-center mb-3">
                    <div class="col-md-2">
                        <span class="badge bg-warning-subtle text-warning py-2 px-3 rounded-pill w-100"><i class="bi bi-car-front"></i> Transport</span>
                    </div>
                    <div class="col-md-8">
                    ...
                    <div class="col-md-2 text-end">
                        <button type="button" class="btn btn-sm btn-outline-warning w-100" onclick="toggleCustomTransport(this)" style="border-radius:12px;">
                            <i class="bi bi-plus"></i> Custom
                        </button>
                    </div>
                    <div class="col-12 custom-transport-row" style="display:none;">
                        <input type="text" class="form-control premium-input mt-1 day-custom-transport" placeholder="Enter custom transport mode (e.g. Private SUV Transfer)">
                    </div>
                </div>
                ...
                <div class="row g-3 align-items-center">
                    <div class="col-md-2">
                        <span class="badge bg-success-subtle text-success py-2 px-3 rounded-pill w-100"><i class="bi bi-lightning-charge"></i> Activities</span>
                    </div>
                    <div class="col-md-10">
                        <select class="form-select select2-spots-multi day-activities" multiple="multiple" style="width: 100%;">
                        </select>
                    </div>
                </div>
            </div>
...
<template id="amenity-tpl">
    <div class="card mb-3 border-0 shadow-sm amenity-item" data-amenity-id="amenity-{ID}" style="border-left: 4px solid #0052cc !important; border-radius: 16px;">
        <div class="card-body p-4">
            <div class="row g-3 align-items-end">
                <div class="col-md-3">
                    <label class="small fw-bold text-muted mb-1">Supplier</label>
                    <select class="form-select premium-input amenity-supplier" onchange="handleSupplierChange('amenity-{ID}', this)" required>
                        <option value="">Select Supplier</option>
                    </select>
                </div>
                <div class="col-md-3">
                    <label class="small fw-bold text-muted mb-1 dynamic-asset-label">Item / Service Type</label>
                    <select class="form-select premium-input amenity-asset" onchange="handleAssetChange('amenity-{ID}', this)" required disabled>
                        <option value="">Select Item</option>
                    </select>
                </div>
                <div class="col-md-3">
                    <label class="small fw-bold text-muted mb-1">Name / Title</label>
                    <input type="text" class="form-control premium-input amenity-name" placeholder="Enter component name" required>
                ...
                <div class="col-md-2">
                    ...
                    <div class="input-group">
                        <span class="input-group-text bg-light border-0" style="border-radius:16px 0 0 16px; font-weight:700;">RM</span>
                        <input type="number" class="form-control text-end amenity-total-price fw-black border-0 bg-light" style="border-radius:0 16px 16px 0; font-size:1.1rem;" value="0.00" step="0.01" readonly>
                    </div>
                </div>
                <div class="col-md-1 text-end">
                    <button type="button" class="btn btn-outline-danger border-0 p-2" onclick="removeAmenity('amenity-{ID}')" style="border-radius:12px;">
            ...
            <div class="row g-3 mt-3 calc-fields bg-light p-3 rounded-4" style="display:none;">
                <div class="col-md-3 calc-base-price">
                    ...
                    <input type="number" step="0.01" class="form-control premium-input amenity-price" value="0.00" oninput="calcAmenityTotal('amenity-{ID}')">
                </div>
                
                <!-- Hotel specific -->
                <div class="col-md-3 calc-days" style="display:none;">
                    <label class="small fw-bold text-muted mb-1">Nights</label>
                    <input type="number" class="form-control premium-input amenity-days" value="1" min="1" oninput="calcAmenityTotal('amenity-{ID}')">
                </div>
                
                <!-- General Quantity -->
                <div class="col-md-3 calc-qty" style="display:none;">
                    <label class="small fw-bold text-muted mb-1">Quantity</label>
                    <input type="number" class="form-control premium-input amenity-qty" value="1" min="1" oninput="calcAmenityTotal('amenity-{ID}')">
                </div>
                ...
                <div class="col-md-3 calc-adult-price" style="display:none;">
                    ...
                    <input type="number" step="0.01" class="form-control premium-input amenity-adult-price" value="0.00" oninput="calcAmenityTotal('amenity-{ID}')">
                </div>
                <div class="col-md-3 calc-adult-qty" style="display:none;">
                    <label class="small fw-bold text-muted mb-1">Adult Count</label>
                    <input type="number" class="form-control premium-input amenity-adult-qty" value="1" min="0" oninput="calcAmenityTotal('amenity-{ID}')">
                </div>
                <div class="col-md-3 calc-child-price" style="display:none;">
                    <label class="small fw-bold text-muted mb-1">Child Price (RM)</label>
                    <input type="number" step="0.01" class="form-control premium-input amenity-child-price" value="0.00" oninput="calcAmenityTotal('amenity-{ID}')">
                </div>
                <div class="col-md-3 calc-child-qty" style="display:none;">
                    <label class="small fw-bold text-muted mb-1">Child Count</label>
                    <input type="number" class="form-control premium-input amenity-child-qty" value="0" min="0" oninput="calcAmenityTotal('amenity-{ID}')">
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    function loadPackageData() {
        Swal.fire({
            ...
            text: 'Fetching details from the server.',
            allowOutsideClick: false,
            didOpen: () => { Swal.showLoading(); }
        });

        $.get('{{ route("admin.group-packages.show", $id) }}', function (pkg) {
            // Update Title
            $('#page-title-main').html(`<i class="bi bi-pencil-square"></i> Edit Group Package: <span class="text-primary">${pkg.name}</span>`);
            ...
            if (pkg.image) {
                ...
                $('#hero-preview img').attr('src', imageUrl);
                $('#hero-preview').removeClass('d-none');
                $('#cover-upload-text').html('<i class="bi bi-check-circle-fill text-success fs-3"></i><p class="small text-muted mt-2">Cover photo loaded</p>');
            }
            ...
            if (pkg.gallery && Array.isArray(pkg.gallery)) {
                ...
                galleryImages.forEach(img => {
                    ...
                    if (!imgUrl.startsWith('http')) {
                        imgUrl = imgUrl.startsWith('/') ? imgUrl : '/storage/' + img;
                    }
                    addGalleryImage(imgUrl, img);
                });
                updateGalleryPaths();
            }
            ...
            // Step 4: Compliance
            if (quillEditors['desc'] && pkg.description) {
                quillEditors['desc'].root.innerHTML = pkg.description;
            }
            ...
            if (pkg.included_services && Array.isArray(pkg.included_services)) {
                pkg.included_services.forEach(inc => addInclusionRow(inc));
            } else {
                addInclusionRow();
            }

            $('#exclusions-container').empty();
            if (pkg.excluded_services && Array.isArray(pkg.excluded_services)) {
                pkg.excluded_services.forEach(exc => addExclusionRow(exc));
            } else {
                addExclusionRow();
            }

            // Pre-select categories Select2 multi-select
            const categoriesVal = pkg.categories || (pkg.category ? [pkg.category] : []);
            $('#categories').val(categoriesVal).trigger('change.select2');
            handleCategoryChange();

            // Cascading destinations loading
            $.ajax({
                ...
                success: function (countries) {
                    ...
                    if (pkg.destination_id) {
                        $.ajax({
                            url: '{{ route("admin.destinations.show", "") }}/' + pkg.destination_id,
                            type: 'GET',
                            dataType: 'json',
                            success: function (dest) {
                                ...
                                setTimeout(() => {
                                    ...
                                    setTimeout(() => {
                                        $('#destination_id').val(pkg.destination_id).trigger('change');
                                    }, 500);
                                }, 500);
                            }
                        });
            ...
            // Fetch Suppliers & Cost Components & Itinerary Days
            const selectedSuppliers = pkg.supplier_ids || (pkg.supplier_id ? [pkg.supplier_id] : []);
            $.get('{{ route("admin.suppliers.index") }}', function(data) {
                const suppliers = data.data || data;
                if (Array.isArray(suppliers)) {
                    cachedSuppliers = suppliers;
                    updateSupplierDropdowns();
                    $('#supplier_ids').val(selectedSuppliers).trigger('change.select2');

                    // Pre-populate Cost Components
                    if (pkg.addon_amenities && Array.isArray(pkg.addon_amenities)) {
                        $('#addon-amenities-container').empty();
                        pkg.addon_amenities.forEach(function (amenity) {
                            addAmenity(amenity);
                        });
                    }

                    // Pre-populate Itinerary Days
                    if (pkg.itinerary && Array.isArray(pkg.itinerary)) {
                        $('#itinerary-timeline').empty();
                        pkg.itinerary.forEach(dayData => {
                            addItineraryDay(dayData);
                        });
                    } else {
                        addItineraryDay();
                    }
    ...
    $('#country_select').on('change', function () {
        ...
        // Prevent clearing if it is during initial data load
        if (locationSelect.data('loading-initial') || destinationSelect.data('loading-initial')) {
            return;
        }
        ...
        if (country) {
            ...
            // Load destinations for the itinerary multi-selects
            $.ajax({
    ...
    $('#location_select').on('change', function () {
        ...
        if (destinationSelect.data('loading-initial')) return;
    ...
    function addAmenity(data = {}) {
        ...
        // Dynamic fields values injection
        if (data.supplier_id) {
            tpl = tpl.replace('value="0.00" step="0.01" readonly>', `value="${data.value || '0.00'}" step="0.01" readonly>`);
        }
        ...
        allSuppliers.forEach(s => {
            const isSelected = data.supplier_id == s.id ? 'selected' : '';
            supplierSelect.append(`<option value="${s.id}" data-type="${s.type}" ${isSelected}>${s.name} (${s.type})</option>`);
        });

        // If pre-loaded data is present
        if (data.supplier_id) {
            const typeInput = row.find('.amenity-type');
            typeInput.val(data.type || '');
            row.find('.amenity-name').val(data.name || '');

            const calcFieldsContainer = row.find('.calc-fields');
            calcFieldsContainer.show();
            row.find('.calc-base-price, .calc-days, .calc-qty, .calc-adult-price, .calc-adult-qty, .calc-child-price, .calc-child-qty').hide();

            const supplierType = data.type || '';
            let dynamicLabel = 'Item / Service Type';

            if (supplierType === 'hotel') {
                dynamicLabel = 'Room Type';
                row.find('.calc-base-price').show().find('.amenity-price').val(data.price || '0.00');
                row.find('.calc-days').show().find('.amenity-days').val(data.days || 1);
                row.find('.calc-qty').show().find('.amenity-qty').val(data.quantity || 1).parent().find('label').text('Rooms Count');
            } else if (supplierType === 'transport') {
                dynamicLabel = 'Vehicle Type';
                row.find('.calc-base-price').show().find('.amenity-price').val(data.price || '0.00');
                row.find('.calc-qty').show().find('.amenity-qty').val(data.quantity || 1).parent().find('label').text('Quantity/Hours');
            } else if (supplierType === 'activity' || supplierType === 'ticket' || supplierType === 'entry_tickets') {
                dynamicLabel = 'Ticket / Activity';
                row.find('.calc-adult-price').show().find('.amenity-adult-price').val(data.adult_price || '0.00');
                row.find('.calc-adult-qty').show().find('.amenity-adult-qty').val(data.adult_count || 1);
                row.find('.calc-child-price').show().find('.amenity-child-price').val(data.child_price || '0.00');
                row.find('.calc-child-qty').show().find('.amenity-child-qty').val(data.child_count || 0);
            } else {
                row.find('.calc-base-price').show().find('.amenity-price').val(data.price || '0.00');
                row.find('.calc-qty').show().find('.amenity-qty').val(data.quantity || 1).parent().find('label').text('Quantity');
            }
            row.find('.dynamic-asset-label').text(dynamicLabel);

            // Fetch and set asset select options
            const assetSelect = row.find('.amenity-asset');
            assetSelect.html('<option value="">Loading...</option>').attr('disabled', true);
            
            $.get(`/api/inventory/suppliers/${data.supplier_id}/assets`, function (assetsData) {
                assetSelect.html('<option value="">Select Item</option>').removeAttr('disabled');
                
                if (assetsData.type === 'hotel') {
                    assetsData.assets.forEach(hotel => {
                        if (hotel.rooms) {
                            hotel.rooms.forEach(room => {
                                const selected = data.asset_id == room.id ? 'selected' : '';
                                assetSelect.append(`<option value="${room.id}" ${selected} data-price="${room.base_price}" data-name="${hotel.name} - ${room.room_type}">${room.room_type} (${hotel.name}) - RM${room.base_price}</option>`);
                            });
                        }
                    });
                } else if (assetsData.type === 'transport') {
                    assetsData.assets.forEach(asset => {
                        const displayName = `${asset.vehicle_type} (${asset.name})`;
                        const selected = data.asset_id == asset.id ? 'selected' : '';
                        assetSelect.append(`<option value="${asset.id}" ${selected} data-price="${asset.base_price || 0}" data-name="${displayName}">${displayName} - RM${asset.base_price || 0}</option>`);
                    });
                } else if (assetsData.type === 'activity' || assetsData.type === 'tickets' || assetsData.type === 'entry_tickets') {
                    assetsData.assets.forEach(asset => {
                        ...
                        const selected = data.asset_id == asset.id ? 'selected' : '';
                        assetSelect.append(`<option value="${asset.id}" ${selected} data-adultprice="${adultPrice}" data-childprice="${childPrice}" data-name="${name}">${name} - Ad: RM${adultPrice} / Ch: RM${childPrice}</option>`);
                    });
                } else if (assetsData.assets && Array.isArray(assetsData.assets)) {
                    assetsData.assets.forEach(asset => {
                        const name = asset.name || 'Unnamed Item';
                        const price = asset.base_price || asset.price || 0;
                        const selected = data.asset_id == asset.id ? 'selected' : '';
                        assetSelect.append(`<option value="${asset.id}" ${selected} data-price="${price}" data-name="${name}">${name} - RM${price}</option>`);
                    });
                }
            });
        }
    ...
    function handleSupplierChange(amenityId, select, preSelectedAssetId = null) {
        ...
        $.get(`/api/inventory/suppliers/${supplierId}/assets`, function (resData) {
            assetSelect.html('<option value="">Select Item</option>').removeAttr('disabled');
            
            if (resData.type === 'hotel') {
                resData.assets.forEach(hotel => {
                    if (hotel.rooms) {
                        hotel.rooms.forEach(room => {
            ...
            } else if (resData.type === 'transport') {
                resData.assets.forEach(asset => {
                    const displayName = `${asset.vehicle_type} (${asset.name})`;
                    const selected = preSelectedAssetId == asset.id ? 'selected' : '';
                    assetSelect.append(`<option value="${asset.id}" ${selected} data-price="${asset.base_price || 0}" data-name="${displayName}">${displayName} - RM${asset.base_price || 0}</option>`);
                });
            } else if (resData.type === 'activity' || resData.type === 'tickets' || resData.type === 'entry_tickets') {
                resData.assets.forEach(asset => {
                    const name = asset.name || asset.attraction_name || 'Unnamed Item';
                    const adultPrice = asset.base_price || asset.adult_price || 0;
                    const childPrice = asset.child_price || 0;
            ...
            } else if (resData.assets && Array.isArray(resData.assets)) {
                resData.assets.forEach(asset => {
                    const name = asset.name || 'Unnamed Item';
                    const price = asset.base_price || asset.price || 0;
                    const selected = preSelectedAssetId == asset.id ? 'selected' : '';
    ...
    function addItineraryDay(data = null) {
        ...
        // Init selects
        card.find('.day-destinations').select2({ theme: 'bootstrap-5', placeholder: 'Select destinations', width: '100%' });
        card.find('.day-meals').select2({ theme: 'bootstrap-5', placeholder: 'Select meals', width: '100%' });
        card.find('.day-activities').select2({ theme: 'bootstrap-5', placeholder: 'Select activities', width: '100%' });
        ...
        currentCountryDestinations.forEach(dest => {
            destSelect.append(`<option value="${dest.id}">${dest.city} - ${dest.name}</option>`);
        });

        if (data) {
            card.find('.day-title').val(data.title || '');
            card.find('.day-description').val(data.notes || data.description || '');
            
            // Destinations value
            if (data.destinations) {
                destSelect.val(data.destinations).trigger('change.select2');
            }
            ...
            if (data.meals) {
                if (Array.isArray(data.meals)) {
                    ...
                    if (data.meals.breakfast === 'Included' || data.meals.breakfast === true) mealsVal.push('Breakfast');
                    if (data.meals.lunch === 'Included' || data.meals.lunch === true) mealsVal.push('Lunch');
                    if (data.meals.dinner === 'Included' || data.meals.dinner === true) mealsVal.push('Dinner');
                }
            }
            card.find('.day-meals').val(mealsVal).trigger('change.select2');
        }
        ...
        if (data) {
            ...
            if (data.hotel && data.hotel.name) {
                if (data.hotel.name.startsWith('hotel_')) {
                    card.find('.day-hotel').val(data.hotel.name);
                } else {
                    card.find('.custom-hotel-row').show();
                    card.find('.day-custom-hotel').val(data.hotel.name);
                    card.find('button[onclick^="toggleCustomHotel"]').addClass('btn-primary').removeClass('btn-outline-primary').html('<i class="bi bi-x"></i> Cancel');
                }
            }

            // Set Transport linking
            if (data.transport) {
                let modeVal = '';
                if (Array.isArray(data.transport) && data.transport[0]) {
                    modeVal = data.transport[0].mode || '';
                } else if (typeof data.transport === 'string') {
                    modeVal = data.transport;
                }
                
                if (modeVal.startsWith('transport_')) {
                    card.find('.day-transport').val(modeVal);
                } else if (modeVal !== '') {
                    card.find('.custom-transport-row').show();
                    card.find('.day-custom-transport').val(modeVal);
                    card.find('button[onclick^="toggleCustomTransport"]').addClass('btn-warning').removeClass('btn-outline-warning').html('<i class="bi bi-x"></i> Cancel');
                }
            }

            // Set Activities linking
            if (data.activities && Array.isArray(data.activities)) {
                let actNames = data.activities.map(a => typeof a === 'object' ? a.name : a);
                card.find('.day-activities').val(actNames).trigger('change.select2');
            }
        }
    }
    ...
    // ----------------------------------------------------
    // FORM SUBMISSION (IMMEDIATE UPDATE)
    // ----------------------------------------------------
    function submitPackageForm() {
        ...
        Swal.fire({
            title: 'Updating Group Package...',
            text: 'Syncing your updated group configuration and vendor allocations.',
            allowOutsideClick: false,
            didOpen: () => { Swal.showLoading(); }
        });

        $.ajax({
            url: '/admin/group-packages/' + packageId,
            type: 'POST',
            data: payload,
            success: function (response) {
                Swal.fire({
                    icon: 'success',
                    title: 'Group Package Updated!',
                    text: 'Your collaborative package template was successfully updated.'
                }).then(() => {
                    window.location.href = '{{ route("admin.group-packages.index") }}';
                });
            },
            error: function (xhr) {
