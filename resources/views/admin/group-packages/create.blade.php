...
@section('content')
    <div class="page-header">
        <h1 class="mb-0"><i class="bi bi-people"></i> Create New Group Package</h1>
        <p class="text-muted mb-0">Add a new group tour package</p>
    </div>
        ...
        <div class="card-body">
            <form id="group-package-form">
                ...
                <div class="d-flex justify-content-between">
                    <a href="{{ route('admin.group-packages.index') }}" class="btn btn-secondary">
                        <i class="bi bi-arrow-left"></i> Cancel
                    </a>
                    <button type="submit" class="btn btn-primary">
                        <i class="bi bi-save"></i> Create Group Package
                    </button>
                </div>
            </form>
        </div>
            ...
            $(document).ready(function () {
                ...
                $('#group-package-form').on('submit', function (e) {
                    ...
                    $.ajax({
                        ...
                        data: formData,
                        success: function (response) {
                            // Redirect to the Manage Itinerary editor for this group package
                            window.location.href = '/admin/group-package-itineraries/' + response.id + '/edit';
                        },
                        error: function (xhr) {
                            let errorMsg = 'Error creating group package';
                            if (xhr.responseJSON) {
