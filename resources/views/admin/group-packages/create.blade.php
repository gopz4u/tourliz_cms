                        ...
                        <div class="col-md-8">
                            ...
                            <div class="row g-4 mt-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="slug" id="slug" class="form-control premium-input" placeholder="Auto-generated slug">
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <div class="d-flex gap-3 mt-2">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="includes_flight" id="includes_flight_no" value="0" checked>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="bg-light p-4 rounded-4 border">
                                ...
                                <div class="form-check form-switch mb-3">
                                    <input class="form-check-input" type="checkbox" name="is_featured" id="is_featured" checked>
