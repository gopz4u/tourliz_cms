...
@section('content')
    <div class="page-header">
        <h1 class="mb-0"><i class="bi bi-tag"></i> Create New Coupon</h1>
    </div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="number" step="0.01" class="form-control @error('value') is-invalid @enderror"
                            id="value" name="value" value="{{ old('value') }}" required min="0">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" step="0.01" class="form-control @error('min_spend') is-invalid @enderror"
                            id="min_spend" name="min_spend" value="{{ old('min_spend') }}" min="0">
