        ...
        <script>
            ...
            $(document).ready(function () {
                ...
                $.get(`/admin/services/${serviceId}`, function (service) {
                    ...
                    $('#supplier_id').val(service.supplier_id || '');
                ...
                function loadSuppliers() {
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            const currentSupplierId = '{{ $service->supplier_id }}';
                            ...
                            if (Array.isArray(suppliers)) {
                                ...
                                Object.keys(groups).sort().forEach(type => {
                                    ...
                                    groups[type].forEach(s => {
                                        const isSelected = s.id == currentSupplierId ? 'selected' : '';
                                        optgroup.append(`<option value="${s.id}" ${isSelected}>${s.name}</option>`);
                                    });
