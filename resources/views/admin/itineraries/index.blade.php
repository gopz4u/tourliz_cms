...
@section('content')
    <div class="page-header">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h2><i class="bi bi-calendar-check me-2"></i>Itineraries</h2>
                <p class="text-muted mb-0">Manage day-by-day package itineraries</p>
            </div>
            <a href="{{ route('admin.packages.index') }}" class="btn btn-outline-primary">
                <i class="bi bi-briefcase me-2"></i>View All Packages
            </a>
        </div>
    </div>
                    ...
                    <tbody>
                        @forelse($packages as $package)
                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    <a href="{{ route('admin.itineraries.preview', $package->id) }}" class="btn btn-sm btn-info"
                                        title="Preview">
                                        <i class="bi bi-eye"></i>
                                    </a>
                                    <a href="{{ route('admin.itineraries.edit', $package->id) }}" class="btn btn-sm btn-primary"
                                        title="Edit">
                                        <i class="bi bi-pencil"></i>
                                    </a>
                                    <a href="{{ route('admin.itineraries.pdf', $package->id) }}" class="btn btn-sm btn-success"
                                        title="Download PDF">
                                        <i class="bi bi-file-pdf"></i>
                                    </a>
                                    <form action="{{ route('admin.itineraries.destroy', $package->id) }}" method="POST"
                                        class="d-inline"
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <p class="text-muted">Go to Packages → Edit Package → Generate Itinerary</p>
                </div>
                <div class="col-md-6">
