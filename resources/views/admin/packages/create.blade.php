            ...
            <div class="wizard-body p-4 p-md-5">
                ...
                <div class="form-step active" id="step-1">
                    <div class="mb-5">
                        ...
                        <input type="text" name="name" class="form-control premium-input form-control-lg fs-4 fw-bold" placeholder="Ex: Luxury Escape to Maldives" required>
                    ...
                    <div class="row g-5">
                        <div class="col-md-8">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="destination_ids[]" id="destination_ids" class="form-select select2" multiple required data-placeholder="Select Primary Cities">
                                        @foreach($destinations as $dest)
                                            <option value="{{ $dest->id }}" data-country="{{ $dest->country }}">{{ $dest->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="mt-5">
                                ...
                                <div id="highlight-editor-container" style="height: 200px; border-radius: 16px; background: #f8fafc;"></div>
                            </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="d-flex gap-3 mt-2">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="includes_flight" value="1">
                                            <label class="form-check-label small fw-bold">Yes</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="includes_flight" value="0" checked>
                        ...
                        <div class="col-md-7">
                            ...
                            <div class="row g-4 mt-2">
                                <div class="col-md-6">
                                    ...
                                    <input type="number" name="markup_percentage" id="markup-in" class="form-control premium-input" value="10" oninput="calculateRates()">
                                </div>
                                <div class="col-md-6">
                                    <label class="premium-label">Government GST (%)</label>
                                    <input type="number" name="gst_percentage" id="gst-in" class="form-control premium-input" value="5" oninput="calculateRates()">
                                </div>
                                <div class="col-md-6">
                                    <label class="premium-label">TCS (If applicable %)</label>
                                    <input type="number" name="tcs_percentage" id="tcs-in" class="form-control premium-input" value="0" oninput="calculateRates()">
                                </div>
                                <div class="col-md-6">
                                    <label class="premium-label">Final Selling Rate (Auto-Calculated)</label>
                                    <input type="number" name="price" id="selling-in" class="form-control premium-input form-control-lg fw-black text-primary" readonly>
                ...
                <div class="form-step" id="step-4">
                    <div class="row g-4">
                        <div class="col-md-6">
                            ...
                            <div id="inc-editor-container" style="height: 200px; border-radius: 16px; background: #f8fafc;"></div>
                        </div>
                        <div class="col-md-6">
                            <label class="premium-label">Package Exclusions</label>
                            <div id="exc-editor-container" style="height: 200px; border-radius: 16px; background: #f8fafc;"></div>
                        </div>
                    </div>
                    ...
                    <div class="row g-4 mt-5">
                        <div class="col-md-6">
                            ...
                            <textarea name="cancellation_policy" class="form-control premium-input" rows="5" placeholder="Define refund brackets..."></textarea>
                        </div>
                        <div class="col-md-6">
                            <label class="premium-label">Terms & Conditions</label>
                            <textarea name="terms" class="form-control premium-input" rows="5" placeholder="Legal fine print..."></textarea>
                        </div>
                    </div>
                            ...
                            <div class="bg-light p-4 rounded-4 border">
                                ...
                                <div class="row g-4">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="meta_title" class="form-control premium-input" placeholder="SEO optimized title">
                                    </div>
                                    <div class="col-md-6">
                                        <label class="premium-label small">Meta Keywords</label>
                                        <input type="text" name="meta_keywords" class="form-control premium-input" placeholder="travel, maldives, luxury, tour">
                                    </div>
                                    <div class="col-12">
                                        <label class="premium-label small">Meta Description</label>
                                        <textarea name="meta_description" class="form-control premium-input" rows="3" placeholder="Brief summary for Google search results..."></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
