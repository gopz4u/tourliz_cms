...
@section('title', 'Edit Premium Holiday Package')
...
<div class="wizard-container py-5">
    ...
    <div class="d-flex justify-content-between align-items-end mb-5">
        <div>
            <h1 class="fw-black text-dark tracking-tight mb-1">Edit Package: {{ $package->name }}</h1>
            <p class="text-muted mb-0">Refining your premium travel experience</p>
        </div>
        <div class="text-end">
            <span class="badge bg-white text-primary border rounded-pill px-3 py-2 fw-bold">
                <i class="bi bi-clock-history me-1"></i> ID: #{{ $package->id }}
            </span>
        </div>
    </div>
        ...
        <div class="wizard-card">
            <div class="wizard-body p-4 p-md-5">
                ...
                <div class="form-step active" id="step-1">
                    <div class="mb-5">
                        ...
                        <input type="text" name="name" class="form-control premium-input form-control-lg fs-4 fw-bold" value="{{ $package->name }}" placeholder="Ex: Luxury Escape to Maldives" required>
                        <p class="small text-muted mt-2">The public identity of this travel experience.</p>
                    </div>
                    ...
                    <div class="row g-5">
                        <div class="col-md-8">
                            <div class="row g-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="package_category" class="form-select premium-input">
                                        @foreach(['Honeymoon', 'Family', 'Budget', 'Standard', 'Premium', 'Adventure'] as $cat)
                                            <option value="{{ $cat }}" {{ $package->package_category == $cat ? 'selected' : '' }}>{{ $cat }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="mt-5">
                                ...
                                <div id="highlight-editor-container" style="height: 200px; border-radius: 16px; background: #f8fafc;">
                            ...
                            <div class="row g-4 mt-4">
                                <div class="col-md-4">
                                    ...
                                    <input type="number" name="min_pax" class="form-control premium-input" value="{{ $package->min_pax }}">
                                </div>
                                <div class="col-md-4">
                                    <label class="premium-label">Guest Limit (Max)</label>
                                    <input type="number" name="max_pax" class="form-control premium-input" value="{{ $package->max_pax }}">
                                </div>
                                <div class="col-md-4">
                                    <label class="premium-label">Flight Included?</label>
                                    <div class="d-flex gap-3 mt-2">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="includes_flight" value="1" {{ $package->includes_flight ? 'checked' : '' }}>
                                            <label class="form-check-label small fw-bold">Yes</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="includes_flight" value="0" {{ !$package->includes_flight ? 'checked' : '' }}>
                        ...
                        <div class="col-md-4">
                            <div class="mb-5">
                                ...
                                <label for="hero-img" class="dropzone-box w-100 mb-0" style="cursor: pointer;">
                                    ...
                                    <p class="small text-muted mt-2">Click to change cover photo</p>
                            ...
                            <div class="bg-light p-4 rounded-4 border">
                                ...
                                <div class="form-check form-switch mb-3">
                                    <input class="form-check-input" type="checkbox" name="is_featured" {{ $package->is_featured ? 'checked' : '' }}>
                                    <label class="form-check-label small fw-bold">Mark as Featured</label>
                                </div>
                                <div class="form-check form-switch mb-3">
                                    <input class="form-check-input" type="checkbox" name="is_trending" {{ $package->is_trending ? 'checked' : '' }}>
                                    <label class="form-check-label small fw-bold">Trending Experience</label>
                                </div>
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" name="is_active" {{ $package->is_active ? 'checked' : '' }}>
                        ...
                        <div class="col-md-7">
                            ...
                            <div class="row g-4 mt-2">
                                <div class="col-md-6">
                                    ...
                                    <input type="number" name="markup_percentage" id="markup-in" class="form-control premium-input" value="{{ $package->markup_percentage ?? 10 }}" oninput="calculateRates()">
                                </div>
                                <div class="col-md-6">
                                    <label class="premium-label">Government GST (%)</label>
                                    <input type="number" name="gst_percentage" id="gst-in" class="form-control premium-input" value="{{ $package->gst_percentage ?? 5 }}" oninput="calculateRates()">
                                </div>
                                <div class="col-md-6">
                                    <label class="premium-label">TCS (If applicable %)</label>
                                    <input type="number" name="tcs_percentage" id="tcs-in" class="form-control premium-input" value="{{ $package->tcs_percentage ?? 0 }}" oninput="calculateRates()">
                                </div>
                                <div class="col-md-6">
                ...
                <div class="form-step" id="step-4">
                    <div class="row g-4">
                        <div class="col-md-6">
                            ...
                            <div id="inc-editor-container" style="height: 200px; border-radius: 16px; background: #f8fafc;">
                                {!! $package->included_services !!}
                            </div>
                        </div>
                        <div class="col-md-6">
                            <label class="premium-label">Package Exclusions</label>
                            <div id="exc-editor-container" style="height: 200px; border-radius: 16px; background: #f8fafc;">
                                {!! $package->excluded_services !!}
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row g-4 mt-5">
                        <div class="col-md-6">
                            ...
                            <textarea name="cancellation_policy" class="form-control premium-input" rows="5" placeholder="Define refund brackets...">{{ $package->cancellation_policy }}</textarea>
                        </div>
                        <div class="col-md-6">
                            <label class="premium-label">Terms & Conditions</label>
                            <textarea name="terms" class="form-control premium-input" rows="5" placeholder="Legal fine print...">{{ $package->terms }}</textarea>
                        </div>
                    </div>
                            ...
                            <div class="bg-light p-4 rounded-4 border">
                                ...
                                <div class="row g-4">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="meta_title" class="form-control premium-input" value="{{ $package->meta_title }}" placeholder="SEO optimized title">
                                    </div>
                                    <div class="col-md-6">
                                        <label class="premium-label small">Meta Keywords</label>
                                        <input type="text" name="meta_keywords" class="form-control premium-input" value="{{ $package->meta_keywords }}" placeholder="travel, maldives, luxury, tour">
                                    </div>
                                    <div class="col-12">
                                        <label class="premium-label small">Meta Description</label>
                                        <textarea name="meta_description" class="form-control premium-input" rows="3" placeholder="Brief summary for Google search results...">{{ $package->meta_description }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="wizard-footer">
                ...
                <div class="ms-auto d-flex align-items-center gap-4">
                    ...
                    <button type="button" class="btn btn-publish px-5 py-3" id="btn-publish" style="display:none;" onclick="submitPackage()">
    ...
    <div class="itinerary-day-card" data-day="{N}">
        <div class="day-header">
            <div class="d-flex align-items-center gap-3">
                ...
                <input type="text" class="form-control border-0 bg-transparent fw-black fs-5 day-title-in" placeholder="Day Theme (e.g. Arrival & Sunset Cruise)" style="width: 400px; outline:none;">
            </div>
            <button type="button" class="btn btn-outline-danger btn-sm border-0 rounded-circle" onclick="deleteDay(this)">
        ...
        <div class="p-4">
            ...
            <div class="bg-light p-4 rounded-4 border">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <button type="button" class="btn btn-sm btn-outline-primary rounded-pill px-3" onclick="addServiceRow({N})">
...
<template id="service-row-tpl">
    <div class="row g-3 mb-3 service-row align-items-end">
        ...
        <div class="col-md-1">
            <button type="button" class="btn btn-outline-danger border-0 mb-1" onclick="$(this).closest('.service-row').remove(); calculateRates();">
...
<script>
    ...
    $(document).ready(function() {
        ...
        if ($('#country_id').val()) {
            ...
            destSelect.select2({ theme: 'bootstrap-5' });
            destSelect.val(currentVal).trigger('change.select2');
        }
    ...
    const allVendors = @json($suppliers->map(function($s) { return ['id' => $s->id, 'name' => $s->name]; }));
    ...
    function submitPackage() {
        ...
        formData.append('included_services', quillEditors['inc'] ? quillEditors['inc'].root.innerHTML : '');
        formData.append('excluded_services', quillEditors['exc'] ? quillEditors['exc'].root.innerHTML : '');
        ...
        Swal.fire({ title: 'Updating Experience...', text: 'Syncing your journey configuration', didOpen: () => { Swal.showLoading(); } });
        $.ajax({
            ...
            processData: false,
            contentType: false,
            success: (res) => { Swal.fire({ icon: 'success', title: 'Package Updated!', text: 'Your multi-vendor experience is now live.' }).then(() => window.location.href = '{{ route("admin.packages.index") }}'); },
            error: (err) => {
                ...
                } else if (err.responseJSON && (err.responseJSON.message || err.responseJSON.error)) {
                    msg = err.responseJSON.message || err.responseJSON.error;
                } else if (err.responseText) {
                    try {
                        let parsed = JSON.parse(err.responseText);
                        msg = parsed.message || parsed.error || err.responseText;
                    } catch(e) {
                        msg = err.responseText.substring(0, 300);
                    }
                } else {
                    msg = err.statusText || 'Server Error';
                }
