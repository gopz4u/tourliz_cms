                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="destination_id" class="form-select select2" required>
                                        @foreach($destinations as $dest)
                                            <option value="{{ $dest->id }}" {{ $package->destination_id == $dest->id ? 'selected' : '' }}>{{ $dest->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-6">
            ...
            <div class="wizard-footer">
                ...
                <div class="ms-auto d-flex align-items-center gap-4">
                    <div class="price-tag d-none d-lg-flex">
                        ...
                        <span class="fw-black text-primary fs-5" id="foot-price">₹{{ number_format($package->price) }}</span>
                    </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        @php
            $initialItinerary = $package->days->map(function($day) {
                return [
