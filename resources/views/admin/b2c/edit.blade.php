...
@section('title', 'Edit B2C Proposal')

@section('content')
    <div class="page-header">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h2><i class="bi bi-pencil-square me-2"></i>Edit B2C Proposal</h2>
            ...
            <div class="d-flex gap-2">
                ...
                <a href="{{ route('admin.b2c-itineraries.index') }}" class="btn btn-outline-secondary">
    ...
    <div class="row">
        ...
        <!-- Hidden Save Form -->
        <form id="saveForm" action="{{ route('admin.b2c-itineraries.update', data_get($itinerary, 'id')) }}" method="POST"
            style="display:none;">
            @csrf @method('PUT')
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="expenseForm">
                            ...
                            <input type="hidden" name="itinerary_type" value="b2c">
                            <div class="mb-2">
...
@push('scripts')
    <script>
                        ...
                        if(this.value) {
                            ...
                            if(item) {
                                ...
                                document.getElementById('wiz-add-btn').onclick = () => {               
                                    // B2C specific selectItem call structure might differ locally if logic differs
                                    // Checks B2C's selectItem implementation if needed. 
                                    // B2C usually has: selectItem(item, subItem).
                                    // But Wait, B2C code snippets didn't show selectItem definition clearly.
                                    // Oh, I can just define the onClick inline or rely on existing global `selectItem`? 
                                    // Wait, B2C view snippet above (lines 1091+) DOES NOT SHOW selectItem being defined there, 
                                    // but it shows `data.forEach`...
                                    // Ah, line 1091+ calls `selectItem`? No, I need to see the buttons.
                                    // Ah, I need to verify `selectItem` exists in B2C.
                                    // Line 847 in B2B defined selectItem.
                                    // B2C probably defines it somewhere too. 
                                    // IF NOT, I might break B2C.
                                    // Let's look for `function selectItem` in B2C.
        ...
        window.shareCustomerQuote = () => {
            ...
            text += `\n🔗 *Full Itinerary Link:* {{ route('admin.b2c-itineraries.pdf', data_get($itinerary, 'id')) }}?public=1\n`;
