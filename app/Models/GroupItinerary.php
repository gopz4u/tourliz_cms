...
class GroupItinerary extends Model
{
    ...
    protected $table = 'group_itineraries';
    ...
    {
        return $this->hasMany(ItineraryExpense::class, 'itinerary_id')->where('itinerary_type', 'group');
    }
